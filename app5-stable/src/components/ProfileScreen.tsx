...
export function ProfileScreen() {
  ...
  const showProfileTab = (tab: 'posts' | 'saved' | 'followers' | 'following') => {
    setActiveTab(tab);
  };
      ...
      <div className="flex items-center mb-6">
        <div className="relative mr-6">
          ...
          <button
            ...
            className="absolute -bottom-1 -right-1 bg-accent text-white rounded-full w-6 h-6 flex items-center justify-center hover:bg-accent-dark transition-colors"
          >
            {isUploading ? (
