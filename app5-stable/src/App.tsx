...
function MainApp() {
  ...
  const showBackButton = ['write-article', 'write-reel', 'paywall', 'article-comments', 'reel-comments', 'private-article-viewer', 'transfer-funds', 'send-email', 'generate-wallet', 'email-history'].includes(currentScreen);
        ...
        <div className="flex items-center space-x-4">
          ...
          {currentScreen === 'ArticleScreen' && (
            <>
              ...
              <button onClick={() => showScreen('migration-test')} className="ml-2 text-gray-700 hover:text-accent transition-colors duration-200" title="Migration Tools">
