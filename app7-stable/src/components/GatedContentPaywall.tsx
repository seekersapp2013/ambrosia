...
export function GatedContentPaywall({
    ...
    const handleAutomatedPayment = async () => {
        if (!hasWallet || !sellerAddress || !contentId) {
            setErrorMessage("Wallet, seller address, or content ID not available");
        ...
        try {
            ...
            // Record the purchase in database to grant access
        ...
        <div className="text-center p-8">
            ...
            {sellerAddress && (
                <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                    <p className="text-xs text-gray-600 mb-1">Creator's wallet:</p>
