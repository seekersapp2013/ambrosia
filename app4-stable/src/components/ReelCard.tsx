        ...
        {reel.isSensitive && !showSensitiveContent ? (
          ...
          <>
            ...
            {reel.isGated && !hasAccess && (
              <div className="absolute inset-0 bg-black bg-opacity-75 flex flex-col items-center justify-center text-white p-4 text-center z-20">
                <i className="fas fa-lock text-4xl mb-4"></i>
                <h3 className="font-bold text-xl mb-2">Premium Reel</h3>
                <p className="mb-4">Unlock this reel to watch the full content</p>
                <div className="bg-accent text-white px-6 py-3 rounded-lg font-medium mb-4">
