        ...
        return (
            <div className="bg-white min-h-screen">
                ...
                <div className="p-4 text-center">
                    <i className="fas fa-lock text-4xl text-accent mb-4"></i>
                    <h2 className="text-xl font-bold mb-2">Premium Content</h2>
                    <p className="text-gray-600 mb-4">
                        This article requires payment to access.
                    </p>
                    ...
                    {isAuthenticated ? (
                        <button 
                            onClick={() => {
                                // For public viewer, we need to navigate differently since onNavigate might not be available
                                // We'll redirect to the main app with paywall params
                                const params = new URLSearchParams({
                                    screen: 'paywall',
                                    contentType: 'article',
                                    contentId: article._id,
                                    title: article.title,
                                    price: article.priceAmount?.toString() || '0',
                        ...
                        <div>
                            <p className="text-sm text-gray-600 mb-4">
                                Please sign in to unlock this premium content.
                            </p>
                            <a
                                href="/"
